	...
	public static String checkEmailAddress(String input) {
		...
		while (running) {
			...
			case 1: 
			    ...
			    // A period must be followed by an alphanumeric character
			    else if (currentChar == '.') {
			        nextState = 0;
			    }

			    // @ finishes the local part
			    else if (currentChar == '@') {
			        nextState = 2;
			        domainPartCounter = 0;
			    }
			...
			case 3:
			    // State 3 has three valid transitions.
			    finalState = true;

			    // Alphanumeric domain character
			    if ((currentChar >= 'A' && currentChar <= 'Z') ||
			        (currentChar >= 'a' && currentChar <= 'z') ||
			        (currentChar >= '0' && currentChar <= '9')) {
			    ...
			    // Hyphen inside a domain section
			    else if (currentChar == '-') {
			    ...
			    // Period starts another domain section
			    else if (currentChar == '.') {
		...
		case 1:
		    ...
		    emailAddressErrorMessage =
		            "The local part must be followed by @ and a valid domain.\n";
		...
		case 2:
		    emailAddressIndexofError = currentCharNdx;
		    emailAddressErrorMessage =
		            "The domain must begin with an alphanumeric character.\n";
		...
		case 4:
		    emailAddressIndexofError = currentCharNdx;
		    emailAddressErrorMessage =
		            "A period or hyphen in the domain must be followed by an alphanumeric character.\n";
