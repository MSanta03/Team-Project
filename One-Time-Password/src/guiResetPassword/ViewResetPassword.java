...
public class ViewResetPassword {
	...
	*/
    ...
    protected static Label label_NewUserCreation = new Label("Password Reset.");
    ...
    protected static Button button_UserSetup = new Button("Reset Password");
	...
	*/
	...
	private ViewResetPassword() {
        ...
        button_UserSetup.setOnAction((_) -> {ControllerResetPassword.doPasswordReset(username); });
