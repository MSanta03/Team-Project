...
public class EmailAddressRecognizer {
	...
	public static String checkEmailAddress(String input) {
		...
		domainPartCounter = 0;				// Reset the domain name character counter
		finalState = false;					// Reset the final state flag
		...
		case 0:
			...
			emailAddressIndexofError = currentCharNdx;		// Copy the index of the current character;
			emailAddressErrorMessage = "The local part must begin with an alphanumeric character.\n";
		...
		case 1:
			...
			emailAddressErrorMessage = "The local part must contain only alphanumeric characters or periods and must be followed by an @ symbol.\n";
		...
		case 2:
			...
			emailAddressIndexofError = currentCharNdx;
			emailAddressErrorMessage = "A domain part must begin with an alphanumeric character.\n";
			return emailAddressErrorMessage + displayInput(input, currentCharNdx);
		...
		case 4:
			...
			emailAddressIndexofError = currentCharNdx;
			emailAddressErrorMessage = "A hyphen in the domain must be followed by an alphanumeric character, and each domain part may not exceed 63 characters.\n";
			return emailAddressErrorMessage + displayInput(input, currentCharNdx);
