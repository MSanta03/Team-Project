...
public class UserNameRecognizer {
	 ...
	 * @version 1.02		2026-08-30	Changed first Char of userName to be Alphabetic "A-Z or a-z",
	 * 									Added '&','-','_', to be allowed for the transition to 
	 * 									state 2 of FSM. Updated the Char limit to 32. Updated the error 
	 * 									messages and comments to reflect the changes.
	 * 
	 */
	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 1: 
				...
				// '.', '&', '-', '_' -> State 2
						...
						currentChar == '-' || currentChar == '_') {		// Check for '.', '&', '-', '_'/
					nextState = 2;
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a '.' or '&' or '-' or '_', must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
